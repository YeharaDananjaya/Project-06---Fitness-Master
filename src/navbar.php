        ...
        <div style="max-width: 1200px; margin: auto; display: flex; justify-content: space-between; align-items: center; padding: 0 20px;">
            ...
            <nav>
                <ul style="list-style: none; padding: 0; display: flex; gap: 20px;">
                    ...
                    <li>
                        <a href="about.php" style="text-decoration: none; color: white; font-weight: 600; padding: 10px 15px; border-radius: 5px; transition: background-color 0.3s, transform 0.3s, box-shadow 0.3s;">Get a Coach</a>
                    </li>
                    <li>
